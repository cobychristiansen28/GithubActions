[![Run App Coby Christiansen](https://github.com/cobychristiansen28/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/cobychristiansen28/GithubActions/actions/workflows/run-app.yaml)
